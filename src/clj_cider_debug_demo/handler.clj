(ns clj-cider-debug-demo.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [clj-cider-debug-demo.routes.home :refer [home-routes]]
            
            [clj-cider-debug-demo.middleware :as middleware]
            [clj-cider-debug-demo.session :as session]
